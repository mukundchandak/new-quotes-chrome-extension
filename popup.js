...
let i = Math.floor(Math.random() * Math.floor(325))
console.log(i)
let dispData = data[i].text + '<br/><br/>' + '-By' + data[i].from
...
let timecommentlink = document.getElementById("timecomment")
let timelink = document.getElementById("showtime");
// let citytemp=document.getElementById("showcity")
let cityname=document.getElementById("showcity")
console.log(timelink)
// console.log(citytemp)
let username="Brijesh",  x = "teststring", long, lat, city, wicon, wtemp, wcounter = 0, wmax = 3600, myquote, author;
...
function getLocation() {
   ...
   xhr.open("GET", "https://api.ipgeolocation.io/ipgeo?apiKey=3e330fcaf50d4fcb95021e547ddbd1b0");
